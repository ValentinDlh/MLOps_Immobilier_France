...
def get_date_max_old_transactions(c):
    '''
...
def generate_new_transactions(new_df):
    ...
    new_df["prix_m2"] = int(new_df["prix"] / new_df["surface_habitable"])
    new_df = new_df[
        ["id_transaction", "date_transaction", "prix", "prix_m2", "adresse", "NOM_COM", "code_postal", "departement",
         "NOM_IRIS", "TYP_IRIS", "vefa", "n_pieces", "surface_habitable"]]
